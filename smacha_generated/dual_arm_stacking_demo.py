...
def main():
    ...
    sm.userdata.block_1_limb = 'left'
    
    sm.userdata.block_2_limb = 'right'
    
    sm.userdata.hover_offset = [[0.0, 0.0, 0.15], [0.0, 0.0, 0.0, 0.0]]
    
    sm.userdata.left_limb_joint_start_positions = [-0.08, -0.99998, -1.18997, 1.94002, 0.67, 1.03001, -0.5]
    
    sm.userdata.right_limb_joint_start_positions = [0.08, -0.99998, 1.18997, 1.94002, -0.67, 1.03001, 0.5]
    
    sm.userdata.table_model_pose_world = Pose(position=Point(x=1.0, y=0.0, z=0.0))
    
    sm.userdata.table_model_ref_frame = 'world'
    
    sm.userdata.block_model_1_pick_pose = [[0.7, 0.15, -0.129], [-0.02496, 0.99965, 0.00738, 0.00486]]
    
    sm.userdata.block_model_1_place_pose = [[0.75, 0.0, -0.129], [-0.02496, 0.99965, 0.00738, 0.00486]]
    
    sm.userdata.block_model_1_pose_world = [[0.6725, 0.1265, 0.7825], [0.0, 0.0, 0.0, 0.0]]
    
    sm.userdata.block_model_1_ref_frame = 'world'
    
    sm.userdata.block_model_2_pick_pose = [[0.7, -0.2, -0.129], [-0.02496, 0.99965, 0.00738, 0.00486]]
    
    sm.userdata.block_model_2_place_pose = [[0.75, 0.0, -0.049], [-0.02496, 0.99965, 0.00738, 0.00486]]
    
    sm.userdata.block_model_2_pose_world = [[0.6725, -0.2235, 0.7825], [0.0, 0.0, 0.0, 0.0]]
    
    sm.userdata.block_model_2_ref_frame = 'world'
    ...
    with sm:
        ...
        smach.StateMachine.add('LOAD_BLOCK_MODEL_1',
                               LoadGazeboModelState('block_1',
        rospkg.RosPack().get_path('baxter_sim_examples')+'/models/block/model.urdf'),
                               transitions={'succeeded':'LOAD_BLOCK_MODEL_2'},
                               remapping={'pose':'block_model_1_pose_world',
                                          'reference_frame':'block_model_1_ref_frame'})
        
        smach.StateMachine.add('LOAD_BLOCK_MODEL_2',
                               LoadGazeboModelState('block_2',
        rospkg.RosPack().get_path('baxter_sim_examples')+'/models/block/model.urdf'),
                               transitions={'succeeded':'PICK_BLOCKS'},
                               remapping={'pose':'block_model_2_pose_world',
        ...
        with sm_pick_blocks:
            ...
            with sm_pick_block_1:
            
                smach.StateMachine.add('MOVE_LEFT_LIMB_TO_START_POSITION',
                                       MoveToJointPositionsState(limb_interfaces),
                                       transitions={'succeeded':'PICK_BLOCK'},
                                       remapping={'limb':'block_1_limb',
                ...
                smach.StateMachine.add('PICK_BLOCK', sm_pick_block,
                                       ...
                                       remapping={'hover_offset':'hover_offset',
                                                  'limb':'block_1_limb',
                                                  'pick_pose':'block_model_1_pick_pose'})
            ...
            with sm_pick_block_2:
            
                smach.StateMachine.add('MOVE_RIGHT_LIMB_TO_START_POSITION',
                                       MoveToJointPositionsState(limb_interfaces),
                                       transitions={'succeeded':'PICK_BLOCK'},
                                       remapping={'limb':'block_2_limb',
                ...
                smach.StateMachine.add('PICK_BLOCK', sm_pick_block,
                                       ...
                                       remapping={'hover_offset':'hover_offset',
                                                  'limb':'block_2_limb',
                                                  'pick_pose':'block_model_2_pick_pose'})
                
            
            smach.Concurrence.add('PICK_BLOCK_2', sm_pick_block_2)
            
        
        smach.StateMachine.add('PICK_BLOCKS', sm_pick_blocks,
        ...
        with sm_stack_blocks:
            ...
            sm_place_block_1.userdata.open_command = 'open'
            
            
            
            
            with sm_place_block_1:
            ...
            smach.StateMachine.add('PLACE_BLOCK_1', sm_place_block_1,
            ...
            sm_place_block_2.userdata.open_command = 'open'
            
            
            
            
            with sm_place_block_2:
            ...
            smach.StateMachine.add('PLACE_BLOCK_2', sm_place_block_2,
                                   transitions={'succeeded':'MOVE_RIGHT_LIMB_TO_START_POSITION'},
                                   remapping={'hover_offset':'hover_offset',
                                              'limb':'block_2_limb',
                                              'place_pose':'block_model_2_place_pose'})
        ...
        smach.StateMachine.add('STACK_BLOCKS', sm_stack_blocks,
                               transitions={'succeeded':'succeeded'})
    ...
    rospy.on_shutdown(lambda: delete_gazebo_model('block_2'))
    
    rospy.on_shutdown(lambda: delete_gazebo_model('block_1'))
