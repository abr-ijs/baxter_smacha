...
def main():
    ...
    sm.userdata.block_model_2_pick_pose = [[0.8, 0.15, -0.129], [-0.02496, 0.99965, 0.00738, 0.00486]]
    
    sm.userdata.block_model_2_place_pose = [[0.75, 0.0, -0.049], [-0.02496, 0.99965, 0.00738, 0.00486]]
    
    sm.userdata.block_model_2_pose_world = [[0.7725, 0.1265, 0.7825], [0.0, 0.0, 0.0, 0.0]]
    ...
    with sm:
        ...
        smach.StateMachine.add('PICK_AND_PLACE_BLOCK_1', sm_pick_and_place_block_1,
        ...
        smach.StateMachine.add('PICK_AND_PLACE_BLOCK_2', sm_pick_and_place_block_2,
                               transitions={'succeeded':'succeeded'},
                               remapping={'hover_offset':'hover_offset',
